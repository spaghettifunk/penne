...
import (
	"github.com/spaghettifunk/penne/lexer"
	"github.com/spaghettifunk/penne/token"
	"github.com/spaghettifunk/penne/ast"
	"fmt"
	"strconv"
)
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: skipping the expression until I find a semicolon
...
func (p *Parser) parseReturnStatement() *ast.ReturnStatement {
	...
	// TODO: i'm skipping the expressions until
	// i find a semicolon
	for !p.curTokenIs(token.SEMICOLON) {
		p.nextToken()
	}
...
func (p *Parser) peekError(t token.TokenType) {
	msg := fmt.Sprintf("expected next token be %s, got %s instead.", t, p.peekToken.Type)
	p.errors = append(p.errors, msg)
}
...
type (
	...
	infixParseFunc func(e ast.Expression) ast.Expression
)
